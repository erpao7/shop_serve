<template>
  <div>
    ...
    <el-dialog title="修改地址" :visible.sync="dialogVisible" width="50%" @closed="addressClosed">
      <el-form
        :model="ruleForm"
        :rules="rules"
        ref="ruleForm"
    ...
    <el-dialog title="物流进度" :visible.sync="progressVisible" width="50%">
        <span>
            <span v-for="(activity,index) in progressInfo" :key="index" :timestapm="activity.time">
                {{activity.context}}
            </span>
        </span>
    </el-dialog>
